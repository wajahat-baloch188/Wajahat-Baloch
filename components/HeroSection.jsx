  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-8 sm:space-y-10 md:space-y-12 max-w-5xl mx-auto">
          {/* Greeting */}
          <div className="animate-fadeInDown">
            <p className="text-primary-600 dark:text-primary-400 font-semibold text-lg sm:text-xl md:text-2xl mb-4">
              👋 Hello, I'm
            </p>
          </div>
          ...
          <div className="animate-fadeInUp space-y-4">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-tight">
              <span className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">
                Wajahat Baloch
              </span>
            </h1>
          ...
          {/* Features */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 w-full max-w-4xl animate-fadeInUp animation-delay-400">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 sm:pt-6 animate-fadeInUp animation-delay-600">
            <Link
              to="projects"
              spy={true}
              smooth={true}
              offset={-100}
              duration={500}
              className="group relative inline-flex items-center justify-center px-8 py-4 sm:px-10 sm:py-5 text-base sm:text-lg font-semibold text-white bg-gradient-to-r from-primary-600 to-primary-500 rounded-xl shadow-lg shadow-primary-500/50 hover:shadow-xl hover:shadow-primary-500/50 hover:scale-105 transform transition-all duration-300 overflow-hidden"
            >
